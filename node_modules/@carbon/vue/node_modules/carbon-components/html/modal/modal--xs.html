...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-768pr501uel">Show
  modal</button>

<div data-modal id="modal-768pr501uel" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-768pr501uel-label" aria-describedby="modal-768pr501uel-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-768pr501uel-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-768pr501uel-heading">Modal heading</p>
