...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ubrx8hhtfa">Show
  modal</button>

<div data-modal id="modal-ubrx8hhtfa" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ubrx8hhtfa-label" aria-describedby="modal-ubrx8hhtfa-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ubrx8hhtfa-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ubrx8hhtfa-heading">Modal heading</p>
