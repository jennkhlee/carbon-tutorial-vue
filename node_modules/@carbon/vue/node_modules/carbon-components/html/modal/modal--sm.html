...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-425dth3pbmi">Show
  modal</button>

<div data-modal id="modal-425dth3pbmi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-425dth3pbmi-label" aria-describedby="modal-425dth3pbmi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-425dth3pbmi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-425dth3pbmi-heading">Modal heading</p>
