...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2yt0j82serm">Show
  modal</button>

<div data-modal id="modal-2yt0j82serm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2yt0j82serm-label" aria-describedby="modal-2yt0j82serm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2yt0j82serm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2yt0j82serm-heading">Modal heading</p>
