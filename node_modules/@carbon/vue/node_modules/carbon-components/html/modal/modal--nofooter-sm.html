...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-v098d8hlb">Show
  modal</button>

<div data-modal id="modal-v098d8hlb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-v098d8hlb-label" aria-describedby="modal-v098d8hlb-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-v098d8hlb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-v098d8hlb-heading">Modal heading</p>
